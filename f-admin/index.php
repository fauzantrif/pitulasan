            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                ...
                <?php
                  switch($_GET['error']){
                    ...
                    case "invalid":
                      ...
                      break;
                    case "unauthorized":
                      echo "Anda harus masuk dahulu!";
                      break;
                    case "blocked":
                      echo "Anda telah diblokir dari sistem.<br><small>Hubungi administrator untuk lebih lanjut.</small>";
                      break;
                  }
                ?>
              </div>
              ...
              <div class="card card-plain">
                <div class="card-header pb-0 text-start">
                  ...
                  <p class="mb-0">Masukkan nama pengguna dan kata sandi untuk melanjutkan</p>
                </div>
                <div class="card-body">
                  <form role="form" method="post" action="./processor/login.php" id="form-login">
                    <div class="mb-3">
